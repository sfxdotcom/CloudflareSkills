...
| wordpress-on-cloudflare | Optimising WordPress sites/plugins: R2 for /wp-content/uploads, `/cdn-cgi/image/` URL-based resizing, Cache Rules for HTML and REST, Workers patterns |
